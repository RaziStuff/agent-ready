...
agent-ready add-to-ci --root /absolute/path/to/repo --uses your-org/agent-ready@v1 --mode required --strict --json
agent-ready add-to-ci --root /absolute/path/to/repo --write --uses your-org/agent-ready@v1 --mode required --strict
