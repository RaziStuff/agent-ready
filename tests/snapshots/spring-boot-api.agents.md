...
- `src/main/java/com/acme/orders/OrdersApplication.java`: Spring Boot application entrypoint.
...
- Primary language appears to be Java.
- Detected frameworks: Spring Boot.
