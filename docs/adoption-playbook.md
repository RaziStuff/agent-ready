...
```bash
agent-ready add-to-ci --json --uses RaziStuff/agent-ready@v0.2.9
```
...
```bash
agent-ready add-to-ci --json --mode advisory --no-strict --uses RaziStuff/agent-ready@v0.2.9
```
...
```bash
agent-ready add-to-ci --write --force --uses RaziStuff/agent-ready@v0.2.9
```
...
```bash
agent-ready add-to-ci --write --force --mode advisory --no-strict --uses RaziStuff/agent-ready@v0.2.9
```
