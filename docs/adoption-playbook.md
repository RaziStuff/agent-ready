...
```bash
agent-ready add-to-ci --json --uses RaziStuff/agent-ready@v0.2.2
```
...
```bash
agent-ready add-to-ci --json --mode advisory --no-strict --uses RaziStuff/agent-ready@v0.2.2
```
...
```bash
agent-ready add-to-ci --write --uses RaziStuff/agent-ready@v0.2.2
```

If replacing an existing workflow is intentional:

```bash
agent-ready add-to-ci --write --force --uses RaziStuff/agent-ready@v0.2.2
```
...
```bash
agent-ready add-to-ci --write --force --mode advisory --no-strict --uses RaziStuff/agent-ready@v0.2.2
```
