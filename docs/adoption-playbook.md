...
```bash
agent-ready add-to-ci --json --uses your-org/agent-ready@v1
```
...
```bash
agent-ready add-to-ci --json --mode advisory --no-strict --uses your-org/agent-ready@v1
```
...
```bash
agent-ready add-to-ci --write --force --uses your-org/agent-ready@v1
```
...
```bash
agent-ready add-to-ci --write --force --mode advisory --no-strict --uses your-org/agent-ready@v1
```
