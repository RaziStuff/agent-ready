...
agent-ready add-to-ci --root /absolute/path/to/repo --uses RaziStuff/agent-ready@v0.1.0 --mode required --strict --json
agent-ready add-to-ci --root /absolute/path/to/repo --write --uses RaziStuff/agent-ready@v0.1.0 --mode required --strict
